pipeline {
  ...
  environment {
    ...
    EXT_USER = 'laurent22'
    EXT_REPO = 'joplin'
    BUILD_VERSION_ARG = 'JOPLIN_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-joplin'
    CONTAINER_NAME = 'joplin'
    DOCKERHUB_IMAGE = 'linuxserver/joplin'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/joplin'
    PR_DOCKERHUB_IMAGE = 'lspipepr/joplin'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-joplin/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-joplin\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-joplin\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Joplin\" \
          --label \"org.opencontainers.image.description=[Joplin](https://joplinapp.org/) is a free, open source note taking and to-do application, which can handle a large number of notes organised into notebooks.\" \
